...
DHL_neutral = open("question-2/Sentiment/Neutral Words DHL", "r")
...
NinjaVan_neutral = open("question-2/Sentiment/Neutral Words NinjaVan", "r")
...
PosLaju_neutral = open("question-2/Sentiment/Neutral Words PosLaju", "r")
...
sentiment_table = {'courier': ['DHL', 'GDex', 'JNT', 'NinjaVan', 'PosLaju'],  #these are just dummy data, need to replace with actual ones which we webscrapped
            ...
            'neutral': [len(DHL_neutral_words), len(GDex_neutral_words), len(JNT_neutral_words), len(NinjaVan_neutral_words), len(PosLaju_neutral_words),]
            }
